...
const createData = async num => {
	...
	async function* dataGenerator() {
		yield '{"state":"completed","username": "admin@GRANULEX.TEST","started_at_utc": "2026-01-16T09:39:05.714404Z",  "finished_at_utc": "2026.01.16 09:39:07.623240", "total_secs": 1.908836,"progress_diff_backup_objects_count": 5152,  "progress_diff_ldap_objects_count": 5152, "progress_diff_objects_count": 66,"result":[';
		for (let i = 0; i < len; i++) {
			let liter = '';
